...
public class bincodesearch {
	 public static String getBankNameByBin(char []numbers, int nCount){
		 int len = BankBinArray.length;
		 int slen, dlen;
		 int i, j;
		 int bEqual;
		 ...
		 bankName = null;		 
		 for(i = 0; i < len; i+= 2){
			 char ch[] = BankBinArray[i].toCharArray();
			 slen = ch.length;
	 ...
	 private static final String[] BankBinArray = {
		 "00405512", "交通银行",
		 "0049104", "交通银行",
		 "0053783", "交通银行",
		 "00601428", "交通银行",
	 ...
	 private static final int[] BankBinArrayCount = {
